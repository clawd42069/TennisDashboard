...
def create_app():
    ...
    def _selection_thresholds():
        return {
            ...
            "actionable_max_edge": float(os.getenv("ACTIONABLE_MAX_EDGE") or 0.14),
            ...
            "watchlist_max_edge": float(os.getenv("WATCHLIST_MAX_EDGE") or 0.18),
            ...
            "watchlist_min_reliability": float(os.getenv("WATCHLIST_MIN_RELIABILITY") or 45.0),
